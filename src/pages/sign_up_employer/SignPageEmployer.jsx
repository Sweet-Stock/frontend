...
export default () => {
        ...
        const signApi = async () => {
          ...
          await api
            ...
            .catch(err => {
              ...
              loginEmployee(err.response.status)
            })
        }
  ...
  const loginEmployee = statusCode => {
    switch (statusCode) {
      case 201:
        navigate('/cadastro/espera')
        break
      case 401:
          ...
          >
            <div className={signProgress === 0 ? 'display-none' : ''}>
              <Button
                ...
                onClick={() => setSignProgress(signProgress - 1)}
                content="Voltar"
              />
            </div>
            <div>
              <Button
                ...
                content={signProgress === 1 ? 'Cadastrar' : 'Próximo'}
              />
            </div>
          </div>
        </div>

...
export default ({
  ...
  return (
    ...
    >
      <InputMask
        id="input_id"
        className="peer focus:invalid:text-red-600 invalid:border-red-500 invalid:animate-shake pl-2 pb-1 mr-0 h-8 w-full font-[Rubik] font-light text-2xl border-b-[1px] border-solid border-bg_neutral-500 rounded-none order-2 transition-colors"
        mask={mask ? mask : false}
        pattern={pattern ? pattern : false}
        required={required ? required : false}
        alwaysShowMask={alwaysShowMask ? alwaysShowMask : false}
        onChange={onChange}
